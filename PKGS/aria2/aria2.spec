...
Patch0:         aria2-0002-options-unlock-connection-per-server-limit.patch
Patch1:         aria2-0003-download-retry-on-slow-speed-and-reset.patch
Patch2:         aria2-0005-option-add-option-to-retry-on-http-4xx.patch
...
This verion is built by machsix https://github.com/machsix/rpmbuild.
It removes the limit of connection per server and links with openssl but not gnutls.
...
%changelog
* Tue Apr 16 2019 Machsix <28209092+machsix@users.noreply.github.com> - 1.34.0-5
- Initial commit of the "unlocked" version
